...
namespace Mphomoses.Controllers
{
    public class FacilitatorsController : Controller
    {
        private readonly MphomosesContext _context;

        public FacilitatorsController(MphomosesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MphomosesContext.Facilitators'  is null.");
            }
            var facilitators = await _context.Facilitators.FindAsync(id);
            if (facilitators != null)
            {
